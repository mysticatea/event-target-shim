...
var EventWrapper = /*#__PURE__*/function (_Event) {
  ...
  function EventWrapper(event) {
    ...
    if (event.cancelBubble) {
      _get__default['default']((_thisSuper = _assertThisInitialized__default['default'](_this), _getPrototypeOf__default['default'](EventWrapper.prototype)), "stopPropagation", _thisSuper).call(_thisSuper);
    }

    if (event.defaultPrevented) {
      _get__default['default']((_thisSuper2 = _assertThisInitialized__default['default'](_this), _getPrototypeOf__default['default'](EventWrapper.prototype)), "preventDefault", _thisSuper2).call(_thisSuper2);
    }

    internalDataMap$1.set(_assertThisInitialized__default['default'](_this), {
      original: event
    }); // Define accessors
    ...
    for (var i = 0; i < keys.length; ++i) {
      ...
      if (!(key in _assertThisInitialized__default['default'](_this))) {
        Object.defineProperty(_assertThisInitialized__default['default'](_this), key, defineRedirectDescriptor(event, key));
      }
    }
  ...
  _createClass__default['default'](EventTarget, [{
    ...
    value: function dispatchEvent(event0) {
      ...
      if (eventData.dispatchFlag) {
        throw new DOMException__default['default']("This event has been in dispatching.", "InvalidStateError");
      }
